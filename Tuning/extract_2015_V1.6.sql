...
prompt *                                                                              *
prompt *  Versão 1.6 - Inmetrics 2015                                                 *
prompt *                                                                              *
prompt ********************************************************************************
prompt
prompt ********************************************************************************
...
prompt *  1.6     *  13/04/2015  *  Emerson Silva    *  Alteração lag(parse/hit ratio)*
prompt ********************************************************************************
prompt
...
spool pga_advisor_timeline.log
...
set termout on;
prompt *    pga_advisor_timeline.log                                                  *
set termout off;
...
spool sga_advisor_timeline.log
...
set termout on;
prompt *    sga_advisor_timeline.log                                                  *
set termout off;
...
spool db_cache_advisor_timeline.log
...
set termout on;
prompt *    db_cache_advisor_timeline.log                                             *
set termout off;
...
spool shared_pool_advisor_timeline.log
...
set termout on;
prompt *    shared_pool_advisor_timeline.log                                          *
set termout off;
...
spool memory_target_advisor_timeline.log
...
set termout on;
prompt *    memory_target_advisor_timeline.log                                        *
set termout off;
...
spool java_pool_advisor_timeline.log
...
set termout on;
prompt *    java_pool_advisor_timeline.log                                            *
set termout off;
...
spool mttr_advisor_timeline.log
...
set termout on;
prompt *    mttr_advisor_timeline.log                                                 *
set termout off;
...
with
  ...
  select instance_number, snap_id, snap_time, contents, filename, avg_read_time_ms,
    ...
    from t1),
  t3 as (
    select instance_number, snap_time, contents, filename, avg_read_time_ms from t2 where rank <= &top_items)
