...
--     @ashtop sql_id 1=1 sysdate-5/(24*60) sysdate
--     @ashtop event,session_state 1=1 sysdate-15/(24*60) sysdate
--     @ashtop sql_id,event,object_name,OBJECT_TYPE sql_id='f4y9vht09b6x5' sysdate-1/24 sysdate
--
-- Example:
--     @ashtop username,sql_id session_type='FOREGROUND' sysdate-1/24 sysdate
--     @ashtop sql_id,event machine='kepler002' "to_date('2015/12/17 15:00:00', 'YYYY/MM/DD HH24:MI:SS')" "to_date('2015/12/17 15:15:00', 'YYYY/MM/DD HH24:MI:SS')"
--
-- Other:
