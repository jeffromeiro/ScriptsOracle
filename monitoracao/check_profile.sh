...
set feed off
set echo off
@/home/oracle/chklist/scripts/check_profile.sql 
EOF
cat /home/oracle/chklist/log/check_profile.lst >> /home/oracle/chklist/log/chklist_db.log
rm /home/oracle/chklist/log/check_profile.lst
